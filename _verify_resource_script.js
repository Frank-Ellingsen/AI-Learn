const resourceData = [
        ...
        {
          file: 'Architecting_the_Orchestrator__State,_Routing,_and_Parallel_Age.mp4',
          tag: 'Agentic AI',
          title: 'Architecting the Orchestrator: State, Routing, and Parallel Agents',
          description: 'Video masterclass on orchestrator design patterns, state graphs, conditional routing, and coordinating parallel autonomous agents.',
          type: 'video',
          size: '56.0 MB',
          search: 'architecting the orchestrator state routing and parallel agents agentic ai architecture video',
        },
        {
        ...
        {
          file: 'Decoding_Classification.mp4',
          tag: 'Classification',
          title: 'Decoding Classification',
          description: 'Video masterclass analyzing classification mechanics, probability thresholds, ROC/AUC curves, and diagnostic trade-offs.',
          type: 'video',
          size: '32.0 MB',
          search: 'decoding classification machine learning roc auc diagnostic playbook video',
        },
        {
        ...
        {
          file: 'Demystifying_Regression.mp4',
          tag: 'Diagnostics',
          title: 'Demystifying Regression',
          description: 'Video masterclass exploring linear and non-linear regression models, residual diagnostics, regularization, and variance metrics.',
          type: 'video',
          size: '34.1 MB',
          search: 'demystifying regression diagnostics residuals machine learning variance video',
        },
        {
        ...
        {
          file: 'The_Data_Pipeline__From_Chaos_to_Clarity.mp4',
          tag: 'Data Engineering',
          title: 'The Data Pipeline: From Chaos to Clarity',
          description: 'Video masterclass on data engineering pipelines, ingestion strategies, data cleansing workflows, and refinery architectures.',
          type: 'video',
          size: '30.4 MB',
          search: 'the data pipeline from chaos to clarity data engineering etl refinery video',
        },
        {
        ...
        {
          file: 'The_Window_of_Context.mp4',
          tag: 'Generative AI',
          title: 'The Window of Context',
          description: 'Video masterclass examining large language model context windows, attention mechanisms, token economics, and retrieval augmentation.',
          type: 'video',
          size: '35.6 MB',
          search: 'the window of context generative ai llm attention rag tokens video',
        },
        {
        ...
        {
          file: 'Unsupervised_Learning.mp4',
          tag: 'Foundations',
          title: 'Unsupervised Learning',
          description: 'Video masterclass breaking down clustering algorithms, dimensionality reduction, latent structure detection, and pattern mining.',
          type: 'video',
          size: '30.6 MB',
          search: 'unsupervised learning clustering pca dimensionality reduction foundations video',
        },
        {
